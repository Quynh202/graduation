...
import com.graduationproject.backend.backendwebsite.helper.CategoryHelper;
...
public class CategoryController {
   ...
   * @return list object.
   */
  @GetMapping(value = "/init/{categoryId}")
  public CategoryModel selectById(@PathVariable String categoryId) {
    return categoryHelper.getById(Long.parseLong(categoryId));
  }
  ...
  public ResponseEntity<Map<String, Boolean>> updateCategory(@PathVariable String categoryId) {
    ...
    Boolean action = categoryHelper.deleteByPrimaryKey(Long.parseLong(categoryId));

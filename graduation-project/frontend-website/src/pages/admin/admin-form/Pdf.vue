...
<template lang="">
  ...
  <div v-else class="h-[100vh]">
    ...
    <div class="relative">
      ...
      <div id="pdf" class="text-slate-600 bg-[#eeeeee] p-3 rounded mt-5">
        <div class="block w-full py-2 text-2xl font-bold text-center text-">HÓA ĐƠN</div>
        <div class="block w-full py-2 text-lg font-bold text-center text-slate-600">
        ...
        <div>
          <table class="w-full text-center">
            <thead class="w-full bg-[#c4c7c8] text-slate-600">

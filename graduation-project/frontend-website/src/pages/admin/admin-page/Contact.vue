...
<template lang="">
  <CommonAdmin title="Liên hệ" actionNew="false">
    <template v-slot:search>
      <form class="flex w-[500px] gap-2 items-center justify-center -ml-7">
        <Input
          type="text"
        ...
        <Button
          ...
          id="search"
          @click="onSearch"
          className="bg-[#80bb35] text-[white] hover:bg-[#] hover:text-white"
        />
      </form>
    </template>
    <template v-slot:thead>
      <thead class="w-full bg-[#80bb35] text-[white]">
        <tr class="rounded-tl-md">
          ...
          <th class="w-[120px]">Tên người liên hệ</th>
          <th class="w-[20px]">Tin nhắn</th>
          <th class="w-[100px]">Email</th>
          <th class="w-[100px]">Ngày gửi</th>

<template lang="">
  <div class="flex items-center justify-center" :class="classChild">
    <button
      class="flex p-2 mr-1 align-middle bg-[#ffb416] hover:bg-[#f3ce7d]"
      @click="decrement"
    >
      <vue-feather class="w-4 h-4" type="minus" />
    </button>
    <input
      class="min-w-[40px] pointer-events-none select-none bg-[#ffb416]  text-center h-full w-[30px] text-white rounded"
      disabled
      type="text"
      :name="name"
      :id="props.name"
    ...
    />
    <button
      class="flex p-2 ml-1 align-middle bg-[#ffb416] hover:bg-[#f3ce7d]"
      @click="increment"
    >

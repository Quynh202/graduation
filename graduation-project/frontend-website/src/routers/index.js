...
const routes = [
...

  {
    ...
    component: () => import("../pages/admin/admin-page/Voucher.vue"),
  },

  {
    path: "/admin/voucher/register",
    name: "VoucherRegisterAdmin",
    meta: {
      layout: 'admin',
      auth: true
    },
    component: () => import("../pages/admin/admin-form/VoucherForm.vue"),
  },
  {
